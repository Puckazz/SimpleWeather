      ...
      builder: (context, controller, _) {
        ...
        return Scaffold(
          ...
          appBar: AppBar(
            ...
            title: Column(
              children: [
                Text('7-Day Forecast', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: Theme.of(context).textTheme.headlineSmall?.color)),
                const SizedBox(height: 4),
                Text(city, style: TextStyle(fontSize: 13, color: Theme.of(context).textTheme.bodyMedium?.color)),
              ],
            ),
          ),
          body: daily.isEmpty
              ? Center(child: Text('No forecast data available', style: Theme.of(context).textTheme.bodyLarge))
              ...
              children: [
                ...
                Consumer<TemperatureUnitController>(
                  builder: (context, unitController, _) {
                    ...
                    final displayTemp = Helpers.getTemperature(tomorrow.tempMax, isFahrenheit: isFahrenheit).round();
                    final displayMin = Helpers.getTemperature(tomorrow.tempMin, isFahrenheit: isFahrenheit).round();
      ...
      child: Row(
        children: [
          ...
          Consumer<TemperatureUnitController>(
            builder: (context, unitController, _) {
              final isFahrenheit = unitController.isFahrenheit;
              final displayMin = Helpers.getTemperature(day.tempMin, isFahrenheit: isFahrenheit).round();
              final displayMax = Helpers.getTemperature(day.tempMax, isFahrenheit: isFahrenheit).round();
              final unitSymbol = unitController.unitSymbol;
              return Row(
        ...
        trailing: Consumer<TemperatureUnitController>(
          builder: (context, unitController, _) {
            ...
            return Column(
              ...
              children: [
                Text('$displayMax°$unit', style: const TextStyle(fontSize: 15, fontWeight: FontWeight.bold, color: Colors.white)),
                const SizedBox(height: 4),
                Text('$displayMin°$unit', style: TextStyle(fontSize: 13, color: Theme.of(context).textTheme.bodyMedium?.color)),
              ],
            );
          },
        ),
