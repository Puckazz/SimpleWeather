      ...
      builder: (context, controller, _) {
        ...
        return Scaffold(
          ...
          appBar: AppBar(
            ...
            title: Column(
              children: [
                Text('7Days Forecast', style: Theme.of(context).textTheme.headlineSmall),
                        ...
                        ? Padding(
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                _StatTile(
                                  icon: Icons.air,
                                  label: '${day.windSpeed.toStringAsFixed(1)} m/s',
                                  title: 'Wind',
                                  color: color,
                                ),
                                const SizedBox(width: 12),
...
class _StatTile extends StatelessWidget {
  ...
  const _StatTile({Key? key, required this.icon, required this.label, required this.title, required this.color}) : super(key: key);
